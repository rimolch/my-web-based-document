<template>
        <Menu as="div" class="relative inline-block text-left">
            <div>
                <MenuButton
                    class="inline-flex w-full justify-center rounded-md  px-4 py-2 text-sm font-medium text-gray-1000
                        ...
                        <MenuItem v-slot="{ active }"
                           class="hover:bg-green-200 cursor-pointer">
                            <ResponsiveNavLink :href="route('logout')"
                                              ...
                                              :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700','block  px-2 py-2 text-sm',]">
                                Log Out
                            </ResponsiveNavLink>
                        </MenuItem>
                    </div>
